...
function OnProgress({ onProgress, allowDrop, drag, onDrop }) {
    return (
        <Stack
            bgcolor={'#f5f5f5'}
            width='32%'
        ...
        >
            ...
            >
                <Stack direction={'row'} alignItems={'center'} spacing={1.5}>
                    ...
                    <Typography fontWeight={'600'} fontSize={'16px'} >On Progress</Typography>
                    <span style={{
                        height: '20px',
                        width: '20px',
                        ...
                        >
                            {onProgress.length > 99 ? '99+' : onProgress.length}
                        </Typography>
                    </span>
                    ...
                    onProgress.map((item, index) => {
                        return (
                            <Stack
                                ...
                                draggable={true}
                                sx={{ cursor: 'grab' }}
                                onDragStart={ev => drag(ev, item.id, 'onProgress')}
                                id={item.id}
                            >
                                <Stack
                                    direction={'row'}
